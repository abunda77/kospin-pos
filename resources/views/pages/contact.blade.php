                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <div class="flex items-start space-x-4 mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-gray-700">
                                    <a href="tel:+628133308688" class="text-green-600 hover:text-green-700 transition-colors">
                                        (+62) 813-3308-688
                                    </a>
                                </p>
                            </div>
                        ...
                        <div class="flex items-start space-x-4 mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-gray-700">
                                    <a href="https://wa.me/628133308688" target="_blank" class="text-green-600 hover:text-green-700 transition-colors">
                                        +62 813-3308-688
                                    </a>
                                </p>
                            </div>
                        ...
                        <div class="flex items-start space-x-4 mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-gray-700">
                                    <a href="mailto:cs@sinaraarthanaya.com" class="text-green-600 hover:text-green-700 transition-colors">
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <a href="https://wa.me/628133308688" target="_blank" 
                            ...
                            <a href="mailto:cs@sinaraarthanaya.com" 
