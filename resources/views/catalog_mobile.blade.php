    ...
    <div class="flex overflow-x-auto snap-x pb-4 -mx-2 hide-scrollbar">
        <div class="flex-shrink-0 w-36 mx-2 snap-start">
            <a href="{{ route('catalog.mobile') }}"
               class="flex gap-3 items-center px-4 py-3 w-full rounded-xl shadow transition-all duration-300 hover:bg-primary-50 hover:shadow-md group {{ !request()->category ? 'bg-gray-200' : 'bg-gray-100' }}">
